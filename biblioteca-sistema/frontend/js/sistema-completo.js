...
function filterLibros() {
    ...
    setTimeout(() => {
        document.querySelectorAll('img[data-libro-id]').forEach(img => {
            window.cargarPortadaGoogle(parseInt(img.dataset.libroId), img);
        });
    }, 200);
}
...
window.registrarDevolucion = function (id_prestamo) {
    ...
    const multaGenerada = diasRetraso * 50.00;
